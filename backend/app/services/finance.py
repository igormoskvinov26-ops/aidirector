...
# Постоянные расходы — 372 117 ₽ в месяц. Считано по выгрузке из YCLIENTS за
# август 2026, первый месяц, выгруженный целиком (до починки постраничного
# обхода приходила девятая часть операций):
#
#     аренда                 170 000
#     уборка                  15 000
...
#                            --------
#                            214 117
#     управляющий             90 000   заданы владельцем: в выгрузке
#     сменный администратор   62 000   всё это лежит одной статьёй
#     налоги                   6 000   «Зарплата персонала» вместе с мастерами
#                            --------
#                            372 117
#
...
#
# Коммуналки в выгрузке нет вовсе — ни отдельной статьёй, ни угадываемой
# суммой внутри прочих. Прежняя оценка в 15 000 из числа убрана: держать в
# расходах сумму, которой не видно в кассе, значит завышать порог.
#
...
DEFAULT_FIXED_MONTHLY = Decimal("372117")
